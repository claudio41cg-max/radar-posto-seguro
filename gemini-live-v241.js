...
async function executeRadarCommand(command){
  ...
  try{
    ...
    if(!app?.route)toolDiagV238.error='routeTo terminou sem rota ativa';
    else if(!app?.navActive)toolDiagV238.error='Rota criada, navegação ainda não ativa';
    stickyDiagV238();
