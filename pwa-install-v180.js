/* Radar Seguro RJ PRO v180 — instalação/atualização PWA. */
(()=>{
'use strict';
if(window.__radarPwaInstallV180)return;
window.__radarPwaInstallV180=true;
...
if('serviceWorker' in navigator){
  window.addEventListener('load',()=>{
    navigator.serviceWorker.register('./service-worker-v180.js',{scope:'./',updateViaCache:'none'})
      .then(reg=>reg.update().catch(()=>{}))
      .catch(err=>console.warn('Service Worker v180 não registrado:',err));
  });
}
