...
document.addEventListener('click',intercept,true);window.addEventListener('pagehide',()=>{window.__RADAR_GEMINI_LIVE_OWNS_MIC=false;manualStop=true;cleanup(true)});ensureUI();setButtons(false);window.RadarGeminiLiveV205={start,stop,toggle,get state(){return{running,starting,setupReady,micSending,introAudioReceived,stage,model:MODEL,wsState:ws?.readyState??-1}}};
})();